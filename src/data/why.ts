// ---------------------------------------------------------------------------
// "Why the Wall" page content: the problem the wall solved, what it solved,
// and what still needed work. Edit the arrays to add or remove points.
// ---------------------------------------------------------------------------
...
export const why = {
  ...
  // The deeper "why" — the wall as a teaching tool (the Vance frame).
  teachingTool: {
    eyebrow: "The idea behind it",
    heading: "A teaching tool, not a display",
    quote: "Follow my learners.",
    quoteAttribution: "Jessica Vance, Evidence of Inquiry, p. 2",
    paragraphs: [
      "That is the instruction the wall was built to follow. A learning wall is a teaching tool, not a documentation tool. You teach into it. You do not just record on it. Following the students meant putting their questions, their dead ends, and their decisions where I could see them.",
      ...
      "Vance's first move is to find a blank space and set an intention for it (Vance, 2025). In week one I gave the class an empty wall and left it empty. The students put the first questions up, not me. A wall the teacher fills is a display. A wall the students fill is a place they come back to.",
  ...
  access: {
    ...
    paragraphs: [
      ...
      "The same inquiry showed up four ways: a written line, a project map, a column in the gap table, and a wall of sticky notes. A student who could not get through a dense paragraph could still read the map. And when it was time to show what they knew, a student who freezes on a worksheet could move a sticky, redraw a connection, or fill an empty cell in the table. The wall did not ask all 23 students to prove themselves the same way.",
      "The Research Unstuck Wall ran the same logic on getting started, which is where a lot of students stall. Before asking an adult, they had a set of moves to try first. Lowering the cost of starting is a UDL idea too. We never said the word UDL to a single ten-year-old. We just built the wall so more of them could get in and stay in.",
    ],
    image: {
  ...
  // What the wall did not fix on its own.
  whatStillNeededWork: [
