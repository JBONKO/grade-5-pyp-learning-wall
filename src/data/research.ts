// ---------------------------------------------------------------------------
// Research Base page. The four source paragraphs are John's own prose, kept
// as written. Edit text freely.
//
// REFERENCES: the well-known titles below use their standard editions. VERIFY
// the exact bibliographic details before relying on them — especially the two
// Vance entries (2025 book + 2026 workshop), which need the publisher / format
// you actually used. Fix any that are off.
// ---------------------------------------------------------------------------

export const research = {
  eyebrow: "Research Base",
  title: "The reading behind the wall",
  intro: "The wall was shaped by four sources I returned to throughout the unit.",
  ...
  pullQuoteAttribution: "From the Vance workshop, Shanghai, 2026",

  workshopImage: {
    src: "/images/vance-workshop-shanghai.jpg",
    alt: "Group photo from the Jessica Vance workshop in Shanghai, April 2026",
    caption:
