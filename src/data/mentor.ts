// ---------------------------------------------------------------------------
// "Mentor Buy-In for Student-Led Inquiry" — the NPQSL leadership/implementation
// project page. This page is about the ADULTS across the WHOLE GRADE (mentor
...
export const mentor = {
  eyebrow: "NPQSL Implementation Project",
  title: "Mentor Buy-In for Student-Led Inquiry",
  intro: "Building a clearer mentor role during the Grade 5 PYP Exhibition.",
    ...
    rows: [
      {
        label: "Project",
        value:
          "NPQSL (National Professional Qualification for Senior Leadership) implementation project",
      },
      { label: "My role", value: "Grade 5 Team Leader and Homeroom Teacher" },
      { label: "Setting", value: "Bilingual IB PYP school, Shanghai" },
      {
        label: "Context",
        value:
          "Grade 5 PYP Exhibition. “One World, Many Voices · 同一个世界，不同的声音”",
      },
      {
        label: "Scale",
        value: "More than 35 student groups and 70+ mentors across the grade",
      },
      {
        label: "Focus",
        value:
          "The mentor meetings themselves: getting students and mentors prepared and clear on their part",
      },
      {
        label: "The challenge",
        value:
          "Build mentor buy-in and clarify the role so adults facilitate while students lead, without it feeling like extra work",
      },
    ],
  },

  // Framing: bigger than the wall, grade-wide, and survey-driven. ~5 paragraphs.
  lead: [
  ...
  aim: {
    heading: "The aim",
    lead: "The aim was to raise mentor buy-in and consistency by making the role clearer and lighter, and by getting both sides ready before the meeting. The line I kept drawing was simple: students lead the meeting, mentors facilitate. I wanted mentors and students clear on:",
    points: [
  ...
  keyMessage: "Mentors are not project managers. Mentors are inquiry coaches.",
  keyMessageLead:
  ...
  stages: {
    heading: "How it ran",
    intro: "I worked through it in four stages: explore, prepare, deliver, sustain.",
    items: [
      {
        name: "Explore",
        body: "I started with a survey. First my own team, then the whole staff, about the mentor process. The answers were clear and a little uncomfortable. Mentors were not sure what their role was, and many felt the process was extra work. That survey set the direction for everything after it.",
      },
      {
        name: "Prepare",
      ...
      {
        name: "Sustain",
        body: "Most of the toolkit now exists: handbook, guidance sheet, student expectations, meeting norms, meeting record, and the overview deck. The next step is to hand it to future Grade 5 teams as a ready set, with the student-prep lesson built in, so a new team does not start from scratch.",
      },
    ],
  },

  moment: {
    heading: "A leadership moment",
    body: [
  ...
  // Artifact slots. Drop an image (a scan or export of each document) at
